...
- Downloads and parses UN and EU sanctions lists (XML)
...
- Debug logs per company; summary info logged at INFO level
...
- SanctionsLoader downloads and parses UN and EU XML sanctions lists
- Extracts all name aliases and categorizes records as ENTITY or INDIVIDUAL
...
- Each company is compared only against sanctioned entities
- Matches above threshold are returned
- Scores use token_sort_ratio or token_set_ratio
...
- [ ] Multiple sanctions sources (OFAC)
